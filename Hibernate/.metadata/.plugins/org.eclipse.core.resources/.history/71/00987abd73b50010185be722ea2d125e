package com.vtech.ams.controller;
...
//		
//		Attendance praveen = new Attendance("Praveen", 98220208117L, true);
//		dao.saveAttendance(praveen);
//		
//		Attendance zaheer = new Attendance("Zaheer", 398093939L, false);
//		dao.saveAttendance(zaheer);
		
//		Attendance varun = dao.getAttendanceById(1);
